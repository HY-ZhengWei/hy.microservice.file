...
<body>
    ...
    <script language="javascript">
        ...
        {
            hideVideoLoading();
            getVideoUrl(videoInit ,'HYVideoA' ,v_IsAuto ,false ,true ,v_IsControl ,v_VideoWidth ,v_VideoHeight ,v_VideoSrc);
            getVideoUrl(videoInit ,'HYVideoB' ,false    ,false ,true ,v_IsControl ,v_VideoWidth ,v_VideoHeight ,v_VideoSrc);
        });
